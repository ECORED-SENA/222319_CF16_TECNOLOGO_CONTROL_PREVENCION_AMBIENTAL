        ...
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '1.1',
            titulo: 'Características de la campaña ambiental',
            hash: 't_1_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '1.2',
            titulo: 'Pasos para el diseño de una campaña ambiental',
            hash: 't_1_2',
          },
        ],
      },
        ...
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '2.1',
            titulo: '¿Qué y cómo nos comunicamos?',
            hash: 't_2_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Los elementos de la comunicación',
            hash: 't_2_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.3',
            titulo: 'Técnicas de expresión y comunicación oral',
            hash: 't_2_3',
          },
        ],
      },
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '4.3',
            titulo: 'El actor social y el contexto',
            hash: 't_4_3',
          },
        ],
      },
        ...
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '5.1',
            titulo: 'Pruebas de percepción',
            hash: 't_5_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '5.2',
            titulo: 'Pruebas de conocimiento',
            hash: 't_5_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '5.3',
            titulo: 'Pruebas de desempeño de grupos sociales',
            hash: 't_5_3',
          },
          {
            icono: 'far fa-file-alt',
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.2',
            titulo: 'Descripción de los procesos de participación ciudadana',
            hash: 't_7_2',
          },
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.5',
            titulo: 'Instancias de la participación ciudadana',
            hash: 't_7_5',
          },
        ],
      },
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '9.4',
            titulo: 'Evaluaciones para las promotorías y capacitaciones',
            hash: 't_9_4',
          },
        ],
      },
